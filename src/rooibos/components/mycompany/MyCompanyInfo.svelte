						...
						>
							<h2 class="text-sm font-medium flex items-center">
								<svg
									...
									class="h-4 w-4 mr-1 text-amber-500 dark:text-amber-400"
									fill="none"
									viewBox="0 0 24 24"
									stroke="currentColor"
								>
								...
								메모{#if memoItems.length > 0}<span class="ml-1">({memoItems.length})</span>{/if}
							</h2>
					...
					<div class="flex flex-col py-1 rounded-2xl border border-gray-50 dark:border-gray-850 mt-0.5">
						...
						>
							<h2 class="text-sm font-medium flex items-center">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									class="h-4 w-4 mr-1 text-gray-600 dark:text-gray-300"
									fill="none"
									viewBox="0 0 24 24"
									stroke="currentColor"
								>
								...
								첨부파일{#if filteredItems.length > 0}<span class="ml-1">({filteredItems.length})</span>{/if}
							</h2>
							<button class="text-gray-500">
								{#if showFilesSection}
									<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
						...
						<div class="flex flex-col border border-gray-50 dark:border-gray-850 rounded-2xl {isMobileOrTablet ? 'mb-4' : 'mt-0.5'}">
							...
							>
								<h2 class="text-sm font-medium flex items-center">
									<svg
										xmlns="http://www.w3.org/2000/svg"
										class="h-4 w-4 mr-1 text-teal-500 dark:text-teal-400"
										fill="none"
										viewBox="0 0 24 24"
										stroke="currentColor"
									>
									...
									채팅{#if chatList && chatList.length > 0}<span class="ml-1">({chatList.length})</span>{/if}
								</h2>
								<button class="text-gray-500">
									{#if showChatsSection}
										<svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
