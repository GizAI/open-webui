...
<div class="rounded-lg flex flex-col gap-2">
	<div class="">
		...
		<div class="flex gap-2.5 items-center mb-1">
			...
			<div>
				...
				>
					<option class="text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800" value="private">Private</option>
					<option class="text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800" value="public">Public</option>
				</select>
	...
	{#if !isPublic}
		...
		<div class="mt-4 border-t pt-3 border-gray-100 dark:border-gray-700/10">
			...
			<div class="flex flex-col gap-2 mb-1 px-0.5">
				{#if accessControl && accessControl.write && accessControl.write.user_ids && accessControl.write.user_ids.length > 0}
