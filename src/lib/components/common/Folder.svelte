...
<div bind:this={folderElement} class="relative {className}">
	...
	{#if collapsible}
		...
		>
			...
			<div
				class="w-full group rounded-md relative flex items-center justify-between hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-800 dark:text-gray-200 transition"
			>
				<button class="w-full py-1.5 pl-2 flex items-center gap-1.5 text-md font-medium">
